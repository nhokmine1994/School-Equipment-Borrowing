...
$borrowStatusColumn = !empty($borrowStatusInfo['ok']) ? ('pm.[' . str_replace(']', ']]', $borrowStatusInfo['column']) . ']') : 'pm.TinhTrangMuon';
$borrowSql = "SELECT TOP 100
        ...
        CAST(NULL AS datetime2) AS NgayTraThucTe,
        pm.SoLuong,
        {$borrowStatusColumn} AS TrangThai,
        CAST(NULL AS nvarchar(255)) AS GhiChu
    FROM PhieuMuon pm
