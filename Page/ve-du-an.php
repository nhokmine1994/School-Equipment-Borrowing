    ...
    <section class="section-wrapper">
      ...
      <div class="maintenance-content">
        ...
        <div style="text-align: center; margin: 20px 0;">
          <img src="../Images/bieu-do.png" alt="Biểu đồ tỷ lệ sử dụng phương pháp mượn thiết bị" style="max-width:640px; width:100%; height:auto; border-radius:12px; box-shadow:0 12px 24px rgba(0,0,0,0.12);">
          <p style="margin-top:12px; font-size:0.94rem; color:#555;">Biểu đồ tỷ lệ hiện tại của quy trình mượn thiết bị trong trường học</p>
        </div>
        <p>
...
graph TD
    ...
    <section class="section-wrapper">
      ...
      <div class="maintenance-content">
        ...
        <div class="trend-roadmap">
          <h4 class="trend-title">Roadmap xu hướng SEB</h4>
          <div class="trend-grid">
            <article class="trend-card">
              <p class="trend-tag">Q1 - Q2</p>
              <h5>Smart Borrowing</h5>
              <p>QR mượn nhanh, giảm thao tác tay và rút ngắn thời gian nhận thiết bị.</p>
            </article>
            <article class="trend-card">
              <p class="trend-tag">Q2 - Q3</p>
              <h5>AI Assistant</h5>
              <p>Chatbot trả lời câu hỏi lặp lại, hỗ trợ tra cứu trạng thái thiết bị tức thì.</p>
            </article>
            <article class="trend-card">
              <p class="trend-tag">Q3 - Q4</p>
              <h5>Omni Notifications</h5>
              <p>Gửi thông báo qua Zalo/email cho lịch mượn, trễ hạn và nhắc trả thiết bị.</p>
            </article>
            <article class="trend-card">
              <p class="trend-tag">Next Stage</p>
              <h5>Multi-School Platform</h5>
              <p>Mở rộng liên trường, chuẩn hóa dữ liệu và tạo hệ sinh thái quản lý thiết bị giáo dục.</p>
            </article>
          </div>
        </div>
        <p>
        ...
        <div class="section-link-right">
          <a href="ve-chung-toi.php" class="section-link-btn"><i class="fas fa-arrow-right"></i> Sang trang Về chúng tôi</a>
        </div>
      </div>
    </section>
