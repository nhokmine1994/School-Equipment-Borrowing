...
<head>
  ...
  <style>
    /* 2 thành viên mỗi dòng cho phần đội ngũ */
    .team-grid {
      display: grid;
    ...
    /* Căn layout: nhiệm vụ trên, hình giữa, tên dưới */
  ...
  <div class="system-container">
    ...
    <section class="section-wrapper">
      ...
      <div class="equipment-container">
        <div class="equipment-grid team-grid">
          <!-- Về dự án -->
          <a href="ve-du-an.php" style="text-decoration: none; color: inherit; display: block;">
            <div class="equipment-card team-card">
              <div class="equipment-info">
                <div class="equipment-time">
                  Về dự án
                </div>
                <div class="equipment-img-box">
                  <img src="../Images/logo.png" alt="Về dự án">
                </div>
                <div class="equipment-name">SEB - Hệ thống mượn/trả thiết bị</div>
          ...
          <!-- Về chúng tôi -->
          <a href="ve-chung-toi.php" style="text-decoration: none; color: inherit; display: block;">
            <div class="equipment-card team-card">
              <div class="equipment-info">
                <div class="equipment-time">
                  Về chúng tôi
                ...
                <div class="equipment-img-box">
                  <img src="../Images/conghau-avatar.jpg" alt="Về chúng tôi">
                </div>
                <div class="equipment-name">Đội ngũ phát triển</div>
                <div class="team-contact">
