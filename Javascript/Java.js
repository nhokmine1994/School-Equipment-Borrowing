document.addEventListener("DOMContentLoaded", () => {
        ...
        authModal.innerHTML = `
            <div class="modal-content">
                ...
                <div id="loginFormContainer" class="auth-form-container">
                    ...
                    <form method="POST" action="${buildRoute('tai-khoan.php')}">
    ...
    function openModal(type) {
        ...
        if (loginForm) {
            loginForm.setAttribute("action", buildRoute('tai-khoan.php'));
            var returnInput = loginForm.querySelector('input[name="return"]');
            if (returnInput) {
                ...
                returnInput.value = window.location.pathname + window.location.search;
                loginForm.insertBefore(returnInput, loginForm.firstChild);
            }
        }
    ...
    // --- SHOW SERVER AUTH ERROR (if any) ---
    (function showServerAuthError() {
        var errMsg = window.__server_auth_error;
        if (!errMsg) return;
        window.__server_auth_error = '';
        setTimeout(function () {
            try {
                ...
                if (!el) {
                    var form = document.querySelector('#loginFormContainer form') || document.querySelector('#authModal #loginFormContainer form');
                    if (form) {
